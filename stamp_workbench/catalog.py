...
TASK_CATALOG = {
    "preprocessing": {
        ...
        "fields": [
            ...
            _field(
                "default_slide_mpp",
                "default_slide_mpp (Optional)",
                "number",
                help_text="Optional. Leave empty to let STAMP infer it from the WSI.",
            ),
        ],
    },
    "slide_encoding": {
        ...
        "fields": [
            ...
            _field(
                ...
                path_role="input",
                path_type="dir",
                help_text="Optional. Only used by specific encoders such as eagle or prism.",
            ),
